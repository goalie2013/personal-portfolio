      ...
      <div className="w-full bg-gray-50 py-16 px-6 lg:px-16 xl:px-24">
        <div className="w-full">
          ...
          <div className="flex justify-center space-x-12">
            ...
            {/* Github Icon */}
            <a href="https://github.com/yourusername" className="text-gray-500 hover:text-gray-900 transition-colors">
            ...
            {/* LinkedIn Icon */}
            <a href="https://linkedin.com/in/yourusername" className="text-gray-500 hover:text-blue-500 transition-colors">
